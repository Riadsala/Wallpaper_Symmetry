...
\begin{abstract}
A century of vision research has demonstrated that symmetry contributes to numerous domains of visual perception \cite{RN1311, RN1166,RN1682,RN1824}. In a 2-D image, the four fundamental symmetries, reflection, rotation, translation and glide reflection, can be combined in 17 distinct ways. These 17 “wallpaper” groups \cite{RN1562,RN1563,RN1425} obey a hierarchy, determined by mathematical group theory, where simpler groups are subgroups of more complex ones\cite{RN1711}. Here we measure symmetry-specific Steady-State Visual Evoked Potentials (SSVEPs), and find that the partial ordering of SSVEPs from visual cortex in human participants ($n=25$), preserve the hierarchical relationships between the wallpaper groups in $88.3\%$ (53 out of 60) of cases. This remarkable consistency between the structure of symmetry representations and mathematical group theory, is likely generated over visual development, through implicit learning of regularities in the environment. 
\end{abstract}
...
\begin{figure}%[tbhp]
\centering
\includegraphics[width=1\linewidth]{../ac_models_eeg_data/plots/subgroup_comprms_Occ_Odd.png}
