...
If we take $p$=0.95 as our cut-off, we can see that the subgroup relations are preserved in 56/63 = 89% and 49/64 = 78% of the comparisons for the primary SSVEP and display durations repectively. This compares to the 32/64= 50% and 22/64 = 35% for the control SSVEP conditions. 
