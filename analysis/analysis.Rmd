...
plot_model_output(my_models$threshold, d_dispthresh, 
                  "Model Fits: Psychophysical Data", "orangered3", "threshold (ms)")
```
...
```{r}
my_models <- list()
my_models$full <- brm(data = comp_summary$threshold, mean_value ~ as.numeric(as.character(index))  + normal)
